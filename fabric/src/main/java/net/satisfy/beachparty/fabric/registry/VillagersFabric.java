...
import net.satisfy.beachparty.util.BeachpartyVillagerUtil;
...
public class VillagersFabric {
    ...
    public static final PoiType BARKEEPER_POI = PointOfInterestHelper.register(BARKEEPER_POI_IDENTIFIER, 1, 12, ObjectRegistry.CABINET.get());
